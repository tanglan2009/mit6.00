    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) >0:
        ...
        # Otherwise (the input is not a single period):
            ...
            if isValidWord(userInput, currentHand, wordList) is False:
            ...
            # Otherwise (the word is valid):
                ...
                print"'%s' earned %d points. Total: %d points" %(userInput,getWordScore(userInput, n), totalPoints)
                print
            #totalPoint = totalPoint + getWordScore(userInput, n)
                # Update the hand 
